...
import com.managementsystem.energy.portlet.keyinformation.KeyInformationChartPreferenceController;
...
@Controller
@RequestMapping("Edit")
public class EnergyStatisticChartPreferenceController extends BaseController {
	private final Log logger = LogFactory
			.getLog(KeyInformationChartPreferenceController.class);
	...
	public ModelAndView setup(RenderRequest request, RenderResponse response,
		...
		mav.setViewName(PORTLETFOLDER + "othermodules/energyStatisticInfoPreferences");//返回一个视图，并保存进入ModelAndView对象中
		return mav;
	}
