...
@Controller
@RequestMapping("Edit")
public class FaultDiagnosisChartPreferenceController extends BaseController {
	...
	public ModelAndView setup(RenderRequest request, RenderResponse response,
		...
		mav.setViewName(PORTLETFOLDER + "othermodules/faultDiagnosisInfoPreferences");//返回一个视图，并保存进入ModelAndView对象中
		return mav;
	}
