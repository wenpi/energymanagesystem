...
@Controller
@RequestMapping("Edit")
public class CommonPieChartPreferenceController extends BaseController {
	private final Log logger = LogFactory
			.getLog(CommonPieChartPreferenceController.class);
	...
	public ModelAndView setup(RenderRequest request, RenderResponse response,
		...
		mav.addObject("commonpiechart", preferenceinfo);

		mav.setViewName(PORTLETFOLDER + "common/commonPieChartPreferences");
		return mav;
	}
