...
@Controller
@RequestMapping("Edit")
public class CommonChartPreferenceController extends BaseController {
	private final Log logger = LogFactory
			.getLog(CommonChartPreferenceController.class);
	...
	public ModelAndView setup(RenderRequest request, RenderResponse response,
		...
		mav.addObject("commonchart", preferenceinfo);

		mav.setViewName(PORTLETFOLDER + "common/commonChartPreferences");
		return mav;
	}
