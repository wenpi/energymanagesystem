...
@Controller
@RequestMapping("VIEW")
public class PieChartViewController extends BaseController {
	...
	public String setup(PortletPreferences prefs,Model model) {
		...
		return PORTLETFOLDER + "chart/pieChartView";
	}
	...
	public Fusionchart getChartData(PortletPreferences prefs,ResourceRequest request,ResourceResponse response) {
		...
		resultMap =  FusionChartUtil.getInstance().renderPieChart(chartService, chartsetting,from,to,count,null,null);
