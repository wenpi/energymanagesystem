...
@Controller
@RequestMapping("VIEW")
public class EfficiencyAnalysisViewController extends BaseController {
	...
	public String setup(PortletPreferences prefs, Model model) {
		...
		model.addAttribute("efficiencyanalysis", preferenceinfo);

		return PORTLETFOLDER + "analysis/efficiencyAnalysisView";
	}
}
