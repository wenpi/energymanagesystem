package com.managementsystem.energy.portlet.buildconsumptionledger;
...
@Controller
@RequestMapping("Edit")
public class BuildConsumptionLedgerChartPreferenceController extends BaseController {
	private final Log logger = LogFactory
			.getLog(BuildConsumptionLedgerChartPreferenceController.class);
	...
	public ModelAndView setup(RenderRequest request, RenderResponse response,
		...
		mav.setViewName(PORTLETFOLDER
				+ "buildconsumptionledger/buildConsumptionLedgerInfoPreferences");// 返回一个视图，并保存进入ModelAndView对象中
		return mav;
	}
