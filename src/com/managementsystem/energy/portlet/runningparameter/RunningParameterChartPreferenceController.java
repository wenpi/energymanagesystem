package com.managementsystem.energy.portlet.runningparameter;
...
@Controller
@RequestMapping("Edit")
public class RunningParameterChartPreferenceController extends BaseController {
	private final Log logger = LogFactory
			.getLog(RunningParameterChartPreferenceController.class);
	...
	public ModelAndView setup(RenderRequest request, RenderResponse response,
		...
		mav.setViewName(PORTLETFOLDER
				+ "runningparameter/runningParameterInfoPreferences");// 返回一个视图，并保存进入ModelAndView对象中
		return mav;
	}
