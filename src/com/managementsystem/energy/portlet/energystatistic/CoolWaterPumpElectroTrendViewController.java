...
@Controller
@RequestMapping("VIEW")
public class CoolWaterPumpElectroTrendViewController extends BaseController {
	...
	public String setup(PortletPreferences prefs, Model model) {
		...
		model.addAttribute("coolwaterpumpelectrotrend", preferenceinfo);

		return PORTLETFOLDER + "energystatistic/coolWaterPumpElectroTrendView";
	}
