...
@Controller
@RequestMapping("VIEW")
public class CoolTowerElectroTrendViewController extends BaseController {
	...
	public String setup(PortletPreferences prefs, Model model) {
		...
		model.addAttribute("cooltowerelectrotrend", preferenceinfo);

		return PORTLETFOLDER + "energystatistic/coolTowerElectroTrendView";
	}
