...
@Controller
@RequestMapping("VIEW")
public class AirConditionBoxElectroTrendViewController extends BaseController {
	...
	public String setup(PortletPreferences prefs, Model model) {
		...
		model.addAttribute("airconditionboxelectrotrend", preferenceinfo);

		return PORTLETFOLDER
				+ "energystatistic/airConditionBoxElectroTrendView";
	}
