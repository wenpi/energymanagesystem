...
@Controller
@RequestMapping("VIEW")
public class AirSystemElectroTrendViewController extends BaseController {
	@Autowired
	...
	public String setup(PortletPreferences prefs, Model model) {
		...
		model.addAttribute("airsystemelectrotrend", preferenceinfo);

		return PORTLETFOLDER + "energystatistic/airSystemElectroTrendView";
	}
