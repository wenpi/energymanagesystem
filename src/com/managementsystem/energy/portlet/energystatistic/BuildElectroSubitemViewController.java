...
@Controller
@RequestMapping("VIEW")
public class BuildElectroSubitemViewController extends BaseController {
	// 能耗统计-建筑用电分项
	@Autowired
	...
	public String setup(PortletPreferences prefs, Model model) {
		...
		model.addAttribute("buildelectrosubitem", preferenceinfo);

		return PORTLETFOLDER + "energystatistic/buildElectroSubitemView";
	}
