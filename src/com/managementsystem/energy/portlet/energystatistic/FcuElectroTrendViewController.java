...
@Controller
@RequestMapping("VIEW")
public class FcuElectroTrendViewController extends BaseController {
	...
	public String setup(PortletPreferences prefs, Model model) {
		...
		model.addAttribute("fcuelectrotrend", preferenceinfo);

		return PORTLETFOLDER + "energystatistic/fcuElectroTrendView";
	}
