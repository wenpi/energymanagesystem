...
@Controller
@RequestMapping("VIEW")
public class CoolElectroTrendViewController extends BaseController {
	...
	public String setup(PortletPreferences prefs, Model model) {
		...
		model.addAttribute("coolelectrotrend", preferenceinfo);

		return PORTLETFOLDER + "energystatistic/coolElectroTrendView";
	}
