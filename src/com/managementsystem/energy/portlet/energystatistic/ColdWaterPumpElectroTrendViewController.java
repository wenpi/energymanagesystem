...
@Controller
@RequestMapping("VIEW")
public class ColdWaterPumpElectroTrendViewController extends BaseController {
	...
	public String setup(PortletPreferences prefs, Model model) {
		...
		model.addAttribute("coldwaterpumpelectrotrend", preferenceinfo);

		return PORTLETFOLDER + "energystatistic/coldWaterPumpElectroTrendView";
	}
