...
@Controller
@RequestMapping("Edit")
public class CommonSingleChartPreferenceController extends BaseController {
	private final Log logger = LogFactory
			.getLog(CommonSingleChartPreferenceController.class);
	...
	public ModelAndView setup(RenderRequest request, RenderResponse response,
		...
		mav.addObject("commonsinglechart", preferenceinfo);

		mav.setViewName(PORTLETFOLDER
				+ "energystatistic/commonSingleChartPreferences");
		return mav;
	}
