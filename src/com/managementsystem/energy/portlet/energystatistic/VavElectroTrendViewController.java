...
@Controller
@RequestMapping("VIEW")
public class VavElectroTrendViewController extends BaseController {
	...
	public String setup(PortletPreferences prefs, Model model) {
		...
		model.addAttribute("vavelectrotrend", preferenceinfo);

		return PORTLETFOLDER + "energystatistic/vavElectroTrendView";
	}
