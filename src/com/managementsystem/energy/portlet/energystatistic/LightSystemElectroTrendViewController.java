...
@Controller
@RequestMapping("VIEW")
public class LightSystemElectroTrendViewController extends BaseController {
	...
	public String setup(PortletPreferences prefs, Model model) {
		...
		model.addAttribute("lightsystemelectrotrend", preferenceinfo);

		return PORTLETFOLDER + "energystatistic/lightSystemElectroTrendView";
	}
