...
@Controller
@RequestMapping("VIEW")
public class CoolRefrigerationViewController extends BaseController {
	...
	public String setup(PortletPreferences prefs, Model model) {
		...
		model.addAttribute("coolrefrigeration", preferenceinfo);

		return PORTLETFOLDER + "energyanalysis/coolRefrigerationView";
	}
}
