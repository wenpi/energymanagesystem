...
@Controller
@RequestMapping("VIEW")
public class CoolSystemEerViewController extends BaseController {
	...
	public String setup(PortletPreferences prefs, Model model) {
		...
		model.addAttribute("coolsystemeer", preferenceinfo);

		return PORTLETFOLDER + "energyanalysis/coolSystemEerView";
	}
}
