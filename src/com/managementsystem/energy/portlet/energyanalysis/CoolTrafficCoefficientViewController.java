...
@Controller
@RequestMapping("VIEW")
public class CoolTrafficCoefficientViewController extends BaseController {
	...
	public String setup(PortletPreferences prefs, Model model) {
		...
		model.addAttribute("cooltrafficcoefficient", preferenceinfo);

		return PORTLETFOLDER + "energyanalysis/coolTrafficCoefficientView";
	}
}
