...
@Controller
@RequestMapping("VIEW")
public class AirConditionSystemEerViewController extends BaseController {
	...
	public String setup(PortletPreferences prefs, Model model) {
		...
		model.addAttribute("airconditionsystemeer", preferenceinfo);
		
		return PORTLETFOLDER + "energyanalysis/airConditionSystemEerView";
	}
}
