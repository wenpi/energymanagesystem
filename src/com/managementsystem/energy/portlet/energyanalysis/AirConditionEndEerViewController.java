...
@Controller
@RequestMapping("VIEW")
public class AirConditionEndEerViewController extends BaseController {
	...
	public String setup(PortletPreferences prefs, Model model) {
		...
		model.addAttribute("airconditionendeer", preferenceinfo);

		return PORTLETFOLDER + "energyanalysis/airConditionEndEerView";
	}
}
