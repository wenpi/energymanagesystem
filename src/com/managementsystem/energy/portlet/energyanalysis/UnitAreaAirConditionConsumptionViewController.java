...
@Controller
@RequestMapping("VIEW")
public class UnitAreaAirConditionConsumptionViewController extends BaseController {
	// 单位面积空调能耗
	@Autowired
	...
	public String setup(PortletPreferences prefs, Model model) {
		return PORTLETFOLDER + "energyanalysis/unitAreaAirConditionConsumptionView";
	}
}
