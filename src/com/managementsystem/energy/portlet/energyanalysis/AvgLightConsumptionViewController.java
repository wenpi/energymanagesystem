...
@Controller
@RequestMapping("VIEW")
public class AvgLightConsumptionViewController extends BaseController {
	...
	public String setup(PortletPreferences prefs, Model model) {
		...
		model.addAttribute("avglightconsumption", preferenceinfo);

		return PORTLETFOLDER + "energyanalysis/avgLightConsumptionView";
	}
}
