...
@Controller
@RequestMapping("VIEW")
public class ColdTrafficCoefficientViewController extends BaseController {
	...
	public String setup(PortletPreferences prefs, Model model) {
		...
		model.addAttribute("coldtrafficcoefficient", preferenceinfo);

		return PORTLETFOLDER + "energyanalysis/coldTrafficCoefficientView";
	}
}
