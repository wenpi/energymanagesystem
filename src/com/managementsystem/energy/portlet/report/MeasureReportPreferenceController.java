...
@Controller
@RequestMapping("Edit")
public class MeasureReportPreferenceController extends BaseController {
	private final Log logger = LogFactory
			.getLog(MeasureReportPreferenceController.class);
	...
	public ModelAndView setup(RenderRequest request, RenderResponse response,
		...
		mav.addObject("measurereport", preferenceinfo);

		mav.setViewName(PORTLETFOLDER + "report/measureReportPreferences");
		return mav;
	}
