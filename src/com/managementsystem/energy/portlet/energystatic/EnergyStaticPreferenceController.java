package com.managementsystem.energy.portlet.energystatic;
...
@Controller
@RequestMapping("Edit")
public class EnergyStaticPreferenceController extends BaseController {

	private final Log logger = LogFactory
			.getLog(EnergyStaticPreferenceController.class);
	...
	public ModelAndView setup(RenderRequest request, RenderResponse response,
		...
		mav.addObject("energyStatic", energyStaticPreferenceInfo);
		mav.setViewName(PORTLETFOLDER + "energystatic/energyStaticPreference");
		return mav;
	}
