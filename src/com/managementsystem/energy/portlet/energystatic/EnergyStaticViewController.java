...
@Controller
@RequestMapping("VIEW")
public class EnergyStaticViewController extends BaseController {
	...
	public String setup(PortletPreferences prefs, Model model) {
		...
		model.addAttribute("energyStatic", energyStaticPreferenceInfo);
		return PORTLETFOLDER + "energystatic/energyStaticView";
	}
