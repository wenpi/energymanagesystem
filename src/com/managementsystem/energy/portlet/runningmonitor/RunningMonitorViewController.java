...
@Controller
@RequestMapping("VIEW")
public class RunningMonitorViewController extends BaseController {
	...
	public String setup(PortletPreferences prefs, Model model) {
		...
		model.addAttribute("runningmonitor", preferenceinfo);

		return PORTLETFOLDER + "runningmonitor/runningMonitorView";
	}
}
