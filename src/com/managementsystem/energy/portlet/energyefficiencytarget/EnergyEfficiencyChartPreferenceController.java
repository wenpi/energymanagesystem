package com.managementsystem.energy.portlet.energyefficiencytarget;
...
@Controller
@RequestMapping("Edit")
public class EnergyEfficiencyChartPreferenceController extends BaseController {
	private final Log logger = LogFactory
			.getLog(EnergyEfficiencyChartPreferenceController.class);
	...
	public ModelAndView setup(RenderRequest request, RenderResponse response,
		...
		mav.setViewName(PORTLETFOLDER
				+ "energyefficiencytarget/energyEfficiencyTargetInfoPreferences");// 返回一个视图，并保存进入ModelAndView对象中
		return mav;
	}
