...
@Controller
@RequestMapping("VIEW")
public class ConsumptionStatisticsViewController extends BaseController {
	...
	public String setup(PortletPreferences prefs, Model model) {
		...
		model.addAttribute("consumptionstatistics", preferenceinfo);

		return PORTLETFOLDER
				+ "consumptionstatistics/consumptionStatisticsView";
	}
}
