		...
		<div class="vision_5">
			<div class="single_chart build_ele_itemize">
				<div class="chart_describe"
					style="background-color:${cooltowerelectrotrend.backgroundColor};">
					<h4 class="h4size">冷却塔用电趋势</h4>
					<div>${cooltowerelectrotrend.description}</div>
				</div>
				...
				<div id="cooltowerelectrotrend" class="chartdivstyle"></div>

				<div class="bottom_link">
					<i><a href="${cooltowerelectrotrend.linkUrl_1}">${cooltowerelectrotrend.linkName_1}</a></i>
				</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	//为首页建筑用电分项报表填充数据 
	//renderToColumnAndLineCharts('cooltowerelectrotrend', 'column', '总能耗(tce)','#6666FF', '2', '');
	renderToColumnAndLineCharts('cooltowerelectrotrend',
			"${cooltowerelectrotrend.chartType}",
			"${cooltowerelectrotrend.yLeftTitle}",
			"${cooltowerelectrotrend.lineColor}",
			"${cooltowerelectrotrend.xStep}",
			"${cooltowerelectrotrend.fillColor}");
</script>