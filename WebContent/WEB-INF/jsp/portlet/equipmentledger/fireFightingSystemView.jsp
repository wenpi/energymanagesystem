		...
		<div class="look_other">
			...
			<div class="tool_groupt">
				<div class="has_border_radius_right downLoad_btn"
					onclick="<portlet:namespace />expToExcel6()"></div>
			</div>
		</div>
		<div class="sub_content chart_content onlychart <portlet:namespace/>showContent6" id="<portlet:namespace />consumptionLeft6"></div>
			...
			$.post(
					'<portlet:resourceURL id="getReportDataList"></portlet:resourceURL>',
					{
						...
						for(var i = 0 ;i<showCataList[0].length;i++){
							content +="<tr>" + (<portlet:namespace />choose_type6 == "day"?("<td>" + <portlet:namespace />start_date6 + "</td>"):"") + "<td>" + showCataList[0][i] + "</td>";
