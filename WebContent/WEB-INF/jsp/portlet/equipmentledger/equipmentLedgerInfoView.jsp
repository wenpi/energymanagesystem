	...
	<div class="content home_reportmanager">
		<div id="main" class="home_reportmanager">
			<div>
				...
				<div class="tab report_page_tab sbtz">
					<div class="tab_menu">
						<ul>
							<li class="cur_tab">
								<div>
					...
					<div class="tab_content current">
						<%@include file="../equipmentledger/airConditionSystemView.jsp"%>
					</div>
					<div class="tab_content">
						<%@include file="../equipmentledger/waterSystemView.jsp"%>
					</div>
					<div class="tab_content">
						<%@include file="../equipmentledger/electricityTransformationSystemView.jsp"%>
					</div>
					<div class="tab_content">
						<%@include file="../equipmentledger/heatingVentilationSystemView.jsp"%>
					</div>
					<div class="tab_content">
						<%@include file="../equipmentledger/hotWaterSystemView.jsp"%>
					</div>
					<div class="tab_content">
						<%@include file="../equipmentledger/fireFightingSystemView.jsp"%>
					</div>
					<div class="tab_content">
						<%@include file="../equipmentledger/officeEquipmentView.jsp"%>
					</div>
