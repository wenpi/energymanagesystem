			...
			<div>
				<div class="title_block report_form" id="_runningparam">
					...
					<div class="table_chart_switch" id="<portlet:namespace />table_chart_switch">
						<div class="chart_switch_btn btn_press">
				...
				<div class="tab report_page_tab yxcs">
					<div class="tab_menu">
						<ul>
							<li class="cur_tab">
								<div>
					...
					<div class="tab_content current">
						<%@include file="../runningparameter/refrigeratorGroupView.jsp"%>
					</div>
					<div class="tab_content">
						<%@include file="../runningparameter/furnaceView.jsp"%>
					</div>
					<div class="tab_content">
						<%@include file="../runningparameter/coolingPumpView.jsp"%>
					</div>
					<div class="tab_content">
						<%@include file="../runningparameter/freezePumpView.jsp"%>
					</div>
					<div class="tab_content">
						<%@include file="../runningparameter/coolingTowerView.jsp"%>
					</div>
					<div class="tab_content">
						<%@include file="../runningparameter/airConditionBoxView.jsp"%>
					</div>
