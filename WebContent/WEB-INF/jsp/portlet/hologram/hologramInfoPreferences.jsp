...
<!-- 
	AUTHOR: LIUCHAO
	Created Date: 2013-12-13 上午8点53分
	LastModified Date:
	Description: 全息图首选项页面
 -->
<style type="text/css">
.spanwidth {
	width: 130px;
...
<form:form commandName="preferenceinfo" id="coreinfo" method="post"
	...
	<div class="ftitle">
		<span class="spanwidth" align="right">默认时间：</span> <input
			id="buildTime" name="buildTime" type="text"
			value="<%=prefs.getValue("buildTime", "")%>">
		<span><a
			href="<portlet:renderURL portletMode="view" windowState="normal"></portlet:renderURL>">«返回</a></span>
	</div>

	<div class="div-table">
		<jsp:include page="../hologram/buildSchemaPreferences.jsp"></jsp:include>
		<br /> <br />
		<jsp:include page="../hologram/detailsPreferences.jsp"></jsp:include>
		<br /> <br />
		<div id="buttons">
...
renderDataGrid("dgridDetail1");//渲染建筑总体的效果
renderDataGrid("dgridArea1_1");//渲染建筑总体的效果
</script>