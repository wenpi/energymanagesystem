...
<!-- 
	AUTHOR: ZOUZHIXIANG
	Created Date: 2013-8-15 下午8点45分
	LastModified Date:
...
<form:form commandName="preferenceinfo" id="importantenergytarget"
	...
	<div class="div-table">
		...
		<div class="div-table-row">
			...
			<div class="div-table-2col">
				<span class="spanwidth" align="right">是否需要乘数：</span> <input
					id="multiplier_2" name="multiplier_2" type="text"
					value="<%=prefs.getValue("multiplier_2", "")%>">
			</div>
		</div>
		...
		<div class="div-table-row">
			...
			<div class="div-table-2col">
				<span class="spanwidth" align="right">保留小数位数：</span> <select
					id="decimals6" name="decimals6" style="width: 43.5%">
					<option value="0.00">保留两位小数</option>
					<option value="0.0">保留一位小数</option>
					<option value="0">取整数</option>
				</select>
		...
		<div class="div-table-row">
			...
			<div class="div-table-2col">
				<span class="spanwidth" align="right">链接名称1：</span> <input
					id="linkName_1_6" name="linkName_1_6" type="text"
					value="<%=prefs.getValue("linkName_1_6", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">链接地址1：</span> <input
					id="linkUrl_1_6" name="linkUrl_1_6" type="text"
					value="<%=prefs.getValue("linkUrl_1_6", "")%>">
			</div>
		...
		<div class="div-table-row">
			...
			<div class="div-table-2col">
				<span class="spanwidth" align="right">链接名称2：</span> <input
					id="linkName_2_6" name="linkName_2_6" type="text"
					value="<%=prefs.getValue("linkName_2_6", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">链接地址2：</span> <input
					id="linkUrl_2_6" name="linkUrl_2_6" type="text"
					value="<%=prefs.getValue("linkUrl_2_6", "")%>">
			</div>
		...
		<div class="div-table-row">
			...
			<div class="div-table-2col">
				<span class="spanwidth" align="right">链接名称3：</span> <input
					id="linkName_3_6" name="linkName_3_6" type="text"
					value="<%=prefs.getValue("linkName_3_6", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">链接地址3：</span> <input
					id="linkUrl_3_6" name="linkUrl_3_6" type="text"
					value="<%=prefs.getValue("linkUrl_3_6", "")%>">
			</div>
