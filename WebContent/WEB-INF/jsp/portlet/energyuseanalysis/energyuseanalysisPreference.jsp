...
<form:form commandName="energyStaticPreferenceInfo" id="commonmorechart"
	...
	<div class="div-table">
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">图表描述2：</span> <input
					id="description_1_2" name="description_1_2" type="text"
					value="<%=prefs.getValue("description_1_2", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">图表描述3：</span> <input
					id="description_1_3" name="description_1_3" type="text"
					value="<%=prefs.getValue("description_1_3", "")%>">
			</div>
		</div>
		<div class="div-table-row">
			<div class="div-table-2col">
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">图表描述2：</span> <input
					id="description_2_2" name="description_2_2" type="text"
					value="<%=prefs.getValue("description_2_2", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">图表描述3：</span> <input
					id="description_2_3" name="description_2_3" type="text"
					value="<%=prefs.getValue("description_2_3", "")%>">
			</div>
		</div>
		...
		<div class="div-table-row">
			...
			<div class="div-table-2col">
				<span class="spanwidth" align="right">图表类型2：</span> <select
					id="chartType_2_2" name="chartType_2_2">
					<option value="line">曲线图</option>
					<option value="column">柱状图</option>
					<option value="area">面积图</option>
				</select>
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">图表描述2：</span> <input
					id="description_3_2" name="description_3_2" type="text"
					value="<%=prefs.getValue("description_3_2", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">图表描述3：</span> <input
					id="description_3_3" name="description_3_3" type="text"
					value="<%=prefs.getValue("description_3_3", "")%>">
			</div>
		</div>
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">图表描述2：</span> <input
					id="description_5_2" name="description_5_2" type="text"
					value="<%=prefs.getValue("description_5_2", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">图表描述3：</span> <input
					id="description_5_3" name="description_5_3" type="text"
					value="<%=prefs.getValue("description_5_3", "")%>">
			</div>
		</div>
		...
		<div class="div-table-row">
			...
			<div class="div-table-2col">
				<span class="spanwidth" align="right">Y轴右侧标题：</span> <input
					id="yRightTitle_5" name="yRightTitle_5" type="text"
					value="<%=prefs.getValue("yRightTitle_5", "")%>">
			</div>
		</div>
