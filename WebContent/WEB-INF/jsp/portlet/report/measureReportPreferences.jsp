...
<div style="background-color: white;">
	...
	<form:form commandName="preferenceinfo" id="measurereport"
		method="post" class="" action="#">
		<br />
		<div class="ftitle">
			<span>&nbsp;&nbsp;&nbsp;<%=prefs.getValue("title", "")%></span><span
				class="title-back"><a class="backstyle"
		...
		<div class="div-table">
			...
			<div class="div-table-row">
				...
				<div id="buttons" style="margin: 0 0 11px 35px;">
					<a href="#" class="easyui-linkbutton"
