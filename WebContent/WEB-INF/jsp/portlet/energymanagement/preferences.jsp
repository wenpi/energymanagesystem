	...
	<div class="div-table-row">
		...
		<div class="div-table-row">
			<div class="div-table-col">
				<div class="fitem">
					<label>能耗目标</label>
					<input id="nhmb" name="nhmb" type="text" value="<%=prefs.getValue("nhmb", "")%>" class="easyui-validatebox">
				</div>
				</div>
			</div>
		...
		<div class="div-table-row">
			<div class="div-table-col">
				<div class="fitem">
					<label>能源消耗量</label>
					<input id="nyxhl" name="nyxhl" type="text" value="<%=prefs.getValue("nyxhl", "")%>" class="easyui-validatebox">
				</div>
				</div>
		</div>
		...
		<div class="div-table-row">
			<div class="div-table-col">
				<div class="fitem">
					<label>百分比</label>
					<input id="bfb" name="bfb" type="text" value="<%=prefs.getValue("bfb", "")%>" class="easyui-validatebox">
				</div>
				</div>
		</div>
