	...
	<div class="div-table">
			...
			<div class="div-table-col">
				<div id="buttons" style="margin-left: 30px;">
					<a href="#" class="easyui-linkbutton"
						onclick="<portlet:namespace/>setNameAndId('dgrid1','chart_name1','chart_id1','chart_ispd1')">左图获取name和id</a>
					<a href="#" class="easyui-linkbutton"
						onclick="<portlet:namespace/>clear('chart_name1','chart_id1','chart_ispd1')">左图清空name/id/ispd</a>&nbsp;&nbsp;&nbsp;
					<a href="#" class="easyui-linkbutton"
						onclick="<portlet:namespace/>setNameAndId('dgrid1','chart_name2','chart_id2','chart_ispd2')">右图获取name和id</a>
					<a href="#" class="easyui-linkbutton"
						onclick="<portlet:namespace/>clear('chart_name2','chart_id2','chart_ispd2')">右图清空name/id/ispd</a>&nbsp;&nbsp;&nbsp;
					<a href="#" class="easyui-linkbutton"
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图Name：</span> <input
					id="chart_name1" name="chart_name1" type="text"
					value="<%=prefs.getValue("chart_name1", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图Name：</span> <input
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图Id：</span> <input
					id="chart_id1" name="chart_id1" type="text"
					value="<%=prefs.getValue("chart_id1", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图Id：</span> <input
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图ispd：</span> <input
					id="chart_ispd1" name="chart_ispd1" type="text"
					value="<%=prefs.getValue("chart_ispd1", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图ispd：</span> <input
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图标题：</span> <input
					id="chartTitle1" name="chartTitle1" type="text"
					value="<%=prefs.getValue("chartTitle1", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图标题：</span> <input
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图图例列表：</span> <input
					id="chartLegends1" name="chartLegends1" type="text"
					value="<%=prefs.getValue("chartLegends1", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图图例列表：</span> <input
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图颜色列表：</span> <input
					id="chartColors1" name="chartColors1" type="text"
					value="<%=prefs.getValue("chartColors1", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图颜色列表：</span> <input
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图Y轴左标题：</span> <input
					id="yLeftTitle1" name="yLeftTitle1" type="text"
					value="<%=prefs.getValue("yLeftTitle1", "")%>">
			</div>

			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图Y轴右标题：</span> <input
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图Y轴单位：</span> <input
					id="ySymbol1" name="ySymbol1" type="text"
					value="<%=prefs.getValue("ySymbol1", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图曲线点类型：</span> <select
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图图例展示方式：</span> <select
					id="legendLayout1" name="legendLayout1" style="width: 29.5%">
					<option value="vertical">垂直</option>
					<option value="horizontal">水平</option>
				</select>
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图图例位置：</span> <select
					id="legendAlign1" name="legendAlign1" style="width: 29.5%">
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">内环大小(%)：</span> <input
					id="innerSize1" name="innerSize1" type="text"
					value="<%=prefs.getValue("innerSize1", "")%>">
			</div>
		</div>
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">饼图输出项：</span> <input
					id="itemName1" name="itemName1" type="text"
					value="<%=prefs.getValue("itemName1", "")%>">
			</div>
			<div class="div-table-2col">
		...
		<div class="div-table-row">
			<div class="div-table-col">
				<div id="buttons" style="margin-left: 30px;">
					<a href="#" class="easyui-linkbutton"
						onclick="<portlet:namespace/>setNameAndId('dgrid2','chart_name3','chart_id3','chart_ispd3')">左图获取name和id</a>
					<a href="#" class="easyui-linkbutton"
						onclick="<portlet:namespace/>clear('chart_name3','chart_id3','chart_ispd3')">左图清空name/id/ispd</a>&nbsp;&nbsp;&nbsp;
					<a href="#" class="easyui-linkbutton"
						onclick="<portlet:namespace/>setNameAndId('dgrid2','chart_name4','chart_id4','chart_ispd4')">右图获取name和id</a>
					<a href="#" class="easyui-linkbutton"
						onclick="<portlet:namespace/>clear('chart_name4','chart_id4','chart_ispd4')">右图清空name/id/ispd</a>&nbsp;&nbsp;&nbsp;
					<a href="#" class="easyui-linkbutton"
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图图例展示方式：</span> <select
					id="legendLayout2" name="legendLayout2" style="width: 29.5%">
					<option value="vertical">垂直</option>
					<option value="horizontal">水平</option>
				</select>
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图图例位置：</span> <select
					id="legendAlign2" name="legendAlign2" style="width: 29.5%">
					<option value="right">右侧</option>
					<option value="left">左侧</option>
				</select>
			</div>
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">内环大小(%)：</span> <input
					id="innerSize2" name="innerSize2" type="text"
					value="<%=prefs.getValue("innerSize2", "")%>">
			</div>
		</div>
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">饼图输出项：</span> <input
					id="itemName2" name="itemName2" type="text"
					value="<%=prefs.getValue("itemName2", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">导出列头名称：</span> <input
		...
		<div class="div-table-row">
			<div class="div-table-col">
				<div id="buttons" style="margin-left: 30px;">
					<a href="#" class="easyui-linkbutton"
						onclick="<portlet:namespace/>setNameAndId('dgrid3','chart_name5','chart_id5','chart_ispd5')">左图获取name和id</a>
					<a href="#" class="easyui-linkbutton"
						onclick="<portlet:namespace/>clear('chart_name5','chart_id5','chart_ispd5')">左图清空name/id/ispd</a>&nbsp;&nbsp;&nbsp;
					<a href="#" class="easyui-linkbutton"
						onclick="<portlet:namespace/>setNameAndId('dgrid3','chart_name6','chart_id6','chart_ispd6')">右图获取name和id</a>
					<a href="#" class="easyui-linkbutton"
						onclick="<portlet:namespace/>clear('chart_name6','chart_id6','chart_ispd6')">右图清空name/id/ispd</a>&nbsp;&nbsp;&nbsp;
					<a href="#" class="easyui-linkbutton"
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图图例展示方式：</span> <select
					id="legendLayout3" name="legendLayout3" style="width: 29.5%">
					<option value="vertical">垂直</option>
					<option value="horizontal">水平</option>
				</select>
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图图例位置：</span> <select
					id="legendAlign3" name="legendAlign3" style="width: 29.5%">
					<option value="right">右侧</option>
					<option value="left">左侧</option>
				</select>
			</div>
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">内环大小(%)：</span> <input
					id="innerSize3" name="innerSize3" type="text"
					value="<%=prefs.getValue("innerSize3", "")%>">
			</div>
		</div>
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">饼图输出项：</span> <input
					id="itemName3" name="itemName3" type="text"
					value="<%=prefs.getValue("itemName3", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">导出列头名称：</span> <input
		...
		<div class="div-table-row">
			<div class="div-table-col">
				<div id="buttons" style="margin-left: 30px;">
					<a href="#" class="easyui-linkbutton"
						onclick="<portlet:namespace/>setNameAndId('dgrid4','chart_name7','chart_id7','chart_ispd7')">左图获取name和id</a>
					<a href="#" class="easyui-linkbutton"
						onclick="<portlet:namespace/>clear('chart_name7','chart_id7','chart_ispd7')">左图清空name/id/ispd</a>&nbsp;&nbsp;&nbsp;
					<a href="#" class="easyui-linkbutton"
						onclick="<portlet:namespace/>setNameAndId('dgrid4','chart_name8','chart_id8','chart_ispd8')">右图获取name和id</a>
					<a href="#" class="easyui-linkbutton"
						onclick="<portlet:namespace/>clear('chart_name8','chart_id8','chart_ispd8')">右图清空name/id/ispd</a>&nbsp;&nbsp;&nbsp;
					<a href="#" class="easyui-linkbutton"
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图Name：</span> <input
					id="chart_name7" name="chart_name7" type="text"
					value="<%=prefs.getValue("chart_name7", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图Name：</span> <input
					id="chart_name8" name="chart_name8" type="text"
					value="<%=prefs.getValue("chart_name8", "")%>">
			</div>
		</div>
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图Id：</span> <input
					id="chart_id7" name="chart_id7" type="text"
					value="<%=prefs.getValue("chart_id7", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图Id：</span> <input
					id="chart_id8" name="chart_id8" type="text"
					value="<%=prefs.getValue("chart_id8", "")%>">
			</div>
		</div>
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图ispd：</span> <input
					id="chart_ispd7" name="chart_ispd7" type="text"
					value="<%=prefs.getValue("chart_ispd7", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图ispd：</span> <input
					id="chart_ispd8" name="chart_ispd8" type="text"
					value="<%=prefs.getValue("chart_ispd8", "")%>">
			</div>
		</div>
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图标题：</span> <input
					id="chartTitle7" name="chartTitle7" type="text"
					value="<%=prefs.getValue("chartTitle7", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图标题：</span> <input
					id="chartTitle8" name="chartTitle8" type="text"
					value="<%=prefs.getValue("chartTitle8", "")%>">
			</div>
		</div>
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图图例列表：</span> <input
					id="chartLegends7" name="chartLegends7" type="text"
					value="<%=prefs.getValue("chartLegends7", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图图例列表：</span> <input
					id="chartLegends8" name="chartLegends8" type="text"
					value="<%=prefs.getValue("chartLegends8", "")%>">
			</div>
		</div>
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图颜色列表：</span> <input
					id="chartColors7" name="chartColors7" type="text"
					value="<%=prefs.getValue("chartColors7", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图颜色列表：</span> <input
					id="chartColors8" name="chartColors8" type="text"
					value="<%=prefs.getValue("chartColors8", "")%>">
			</div>
		</div>
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图图例展示方式：</span> <select
					id="legendLayout4" name="legendLayout4" style="width: 29.5%">
					<option value="vertical">垂直</option>
					<option value="horizontal">水平</option>
				</select>
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图图例位置：</span> <select
					id="legendAlign4" name="legendAlign4" style="width: 29.5%">
					<option value="right">右侧</option>
					<option value="left">左侧</option>
				</select>
			</div>
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">内环大小(%)：</span> <input
					id="innerSize4" name="innerSize4" type="text"
					value="<%=prefs.getValue("innerSize4", "")%>">
			</div>
		</div>
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">饼图输出项：</span> <input
					id="itemName4" name="itemName4" type="text"
					value="<%=prefs.getValue("itemName4", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">导出列头名称：</span> <input
		...
		<div class="div-table-row">
			<div class="div-table-col">
				<div id="buttons" style="margin-left: 30px;">
					<a href="#" class="easyui-linkbutton"
						onclick="<portlet:namespace/>setNameAndId('dgrid5','chart_name9','chart_id9','chart_ispd9')">获取name和id</a>
					<a href="#" class="easyui-linkbutton"
						onclick="<portlet:namespace/>clear('chart_name9','chart_id9','chart_ispd9')">清空name/id/ispd</a>&nbsp;&nbsp;&nbsp;
					<a href="#" class="easyui-linkbutton"
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">Name：</span> <input
					id="chart_name9" name="chart_name9" type="text"
					value="<%=prefs.getValue("chart_name9", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">Id：</span> <input
					id="chart_id9" name="chart_id9" type="text"
					value="<%=prefs.getValue("chart_id9", "")%>">
			</div>
		</div>
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">ispd：</span> <input
					id="chart_ispd9" name="chart_ispd9" type="text"
					value="<%=prefs.getValue("chart_ispd9", "")%>">
			</div>
		</div>
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">图表标题：</span> <input
					id="chartTitle9" name="chartTitle9" type="text"
					value="<%=prefs.getValue("chartTitle5", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">图例列表：</span> <input
					id="chartLegends9" name="chartLegends9" type="text"
					value="<%=prefs.getValue("chartLegends9", "")%>">
			</div>
		</div>
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">颜色列表：</span> <input
					id="chartColors9" name="chartColors9" type="text"
					value="<%=prefs.getValue("chartColors9", "")%>">
			</div>
		</div>
		...
		<div class="div-table-row">
			...
			<div class="div-table-2col">
				<span class="spanwidth" align="right">连接线宽：</span> <input
					id="connLineWidth" name="connLineWidth" title="为空则默认为2，为0则不显示连接线"
					type="text" value="<%=prefs.getValue("connLineWidth", "")%>">
			</div>
		</div>
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图X轴间隔：</span> <input
					id="xStep" name="xStep" type="text"
					value="<%=prefs.getValue("xStep", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图线样式：</span> <input
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图表类型1：</span> <select
					id="chartType1" name="chartType1" style="width: 29.5%">
			...
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图表类型2：</span> <select
					id="chartType2" name="chartType2" style="width: 29.5%">
					<option value="line">曲线图</option>
					<option value="column">柱状图</option>
					<option value="area">面积图</option>
				</select>
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图显示X轴网格线：</span> <select
			...
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图显示Y轴网格线:</span> <select
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图半径列表：</span> <input
					id="radiusList" name="radiusList" type="text"
					value="<%=prefs.getValue("radiusList", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图Y轴数据列表：</span> <input
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">左图填充颜色列表：</span> <input
					id="c_fillColors" name="c_fillColors" type="text"
					value="<%=prefs.getValue("c_fillColors", "")%>">
			</div>
			<div class="div-table-2col">
				<span class="spanwidth" align="right">图例区宽度：</span> <input
					id="legendWidth" name="legendWidth" type="text"
					value="<%=prefs.getValue("legendWidth", "")%>">
			</div>
		</div>

		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图表类型：</span> <select
					id="chartType3" name="chartType3" style="width: 29.5%">
			...
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图是否乘数：</span> <input
		...
		<div class="div-table-row">
			<div class="div-table-2col">
				<span class="spanwidth" align="right">右图图表字体颜色：</span> <input
					id="wordColor" name="wordColor" type="text"
					value="<%=prefs.getValue("wordColor", "")%>">
			</div>
			<div class="div-table-2col">
...
$("#chartType3").val('<%=prefs.getValue("chartType3","")%>');
...
$("#legendLayout1").val('<%=prefs.getValue("legendLayout1","")%>');
$("#legendAlign1").val('<%=prefs.getValue("legendAlign1","")%>');
//渲染建筑总用电报表的效果
renderDataGrid("dgrid2");
$("#symbol2").val('<%=prefs.getValue("symbol2","")%>');
$("#legendLayout2").val('<%=prefs.getValue("legendLayout2","")%>');
$("#legendAlign2").val('<%=prefs.getValue("legendAlign2","")%>');
//渲染空调总用电报表的效果
renderDataGrid("dgrid3");
$("#symbol3").val('<%=prefs.getValue("symbol3","")%>');
$("#legendLayout3").val('<%=prefs.getValue("legendLayout3","")%>');
$("#legendAlign3").val('<%=prefs.getValue("legendAlign3","")%>');
//渲染建筑空间用电报表的效果
renderDataGrid("dgrid4");
$("#symbol4").val('<%=prefs.getValue("symbol4","")%>');
$("#legendLayout4").val('<%=prefs.getValue("legendLayout4","")%>');
$("#legendAlign4").val('<%=prefs.getValue("legendAlign4","")%>');
//渲染建筑碳排放量报表的效果
renderDataGrid("dgrid5");
$("#symbol5").val('<%=prefs.getValue("symbol5","")%>');
$("#legendLayout5").val('<%=prefs.getValue("legendLayout5","")%>');
$("#legendAlign5").val('<%=prefs.getValue("legendAlign5","")%>');
