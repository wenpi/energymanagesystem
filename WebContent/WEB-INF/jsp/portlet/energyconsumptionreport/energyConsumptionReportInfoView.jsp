	...
	<div class="content home_reportmanager">
		<div id="main" class="home_reportmanager">
			<div>
				...
				<div class="tab report_page_tab nhbb">
					<div class="tab_menu">
						<ul>
							<li class="cur_tab">
								<div>
					...
					<div class="tab_content current">
						<%@include file="../energyconsumptionreport/reportConsumptionView.jsp"%>
					</div>
					<div class="tab_content">
						<%@include file="../energyconsumptionreport/reportTotalElectricityView.jsp"%>
					</div>
					<div class="tab_content">
						<%@include file="../energyconsumptionreport/reportAirConditionView.jsp"%>
					</div>
					<div class="tab_content">
						<%@include file="../energyconsumptionreport/reportBuildSpaceView.jsp" %>
					</div>
					<div class="tab_content">
						<%@include file="../energyconsumptionreport/reportBuildCo2View.jsp" %>
					</div> 
			...
			<div class="dialog-body">
				...
				<div class="dialog-popover-btn-group">
					...
					<div class="filter_widget tool_3">
						...
						<select class="selectpicker_2" id = "<portlet:namespace />choose_type">
					...
					<div class="filter_widget tool_4">
						...
						<input type="text" id="<portlet:namespace />from_date" onclick="<portlet:namespace />selectdate()"/> <span class="to">至</span> <input
							type="text" id="<portlet:namespace />to_date" readonly="readonly"/>
					</div>
					...
					<div class="tool_groupt">
						<div class="has_border_radius_left search_btn" onclick = "<portlet:namespace />confirm()"></div>
						<div class="has_border_radius_right downLoad_btn" onclick="<portlet:namespace />expToExcel()"></div>
					</div>
				</div>
				<!-- table -->
				<div id="<portlet:namespace />zoomax" style="width:940px;height:660px"></div>
			</div>
		</div>
	</div>
</div>
