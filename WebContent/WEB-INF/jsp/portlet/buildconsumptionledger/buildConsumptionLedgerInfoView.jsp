...
<!-- 
	AUTHOR: LIUCHAO
	Created Date: 2013-11-29 下午6点16分
	LastModified Date:
	Description: 建筑用能账单-切换页面
 -->
<div class="div-table model_width">
	<div class="content home_reportmanager">
		<div id="main" class="home_reportmanager">
			<div>
				<div class="title_block report_form" id="_energymachine">
				...
				<div class="tab report_page_tab jzynzd">
					<div class="tab_menu">
						<ul>
							<li class="cur_tab">
								<div>
					...
					<div class="tab_content current">
						<%@include file="../buildconsumptionledger/totalLedgerView.jsp"%>
					</div>
					<div class="tab_content">
						<%@include file="../buildconsumptionledger/electricityLedgerView.jsp"%>
					</div>
					<div class="tab_content">
						<%@include file="../buildconsumptionledger/gasLedgerView.jsp"%>
					</div>
					<div class="tab_content">
						<%@include file="../buildconsumptionledger/waterLedgerView.jsp"%>
					</div>
			...
			<div class="dialog-body">
				...
				<div class="dialog-popover-btn-group">
					...
					<div class="filter_widget tool_6">
						...
						<input type="text" id="<portlet:namespace />choose_year" onclick="<portlet:namespace />selectdate()"/>
					</div>
...
function <portlet:namespace />selectdate(){
	...
	WdatePicker({
		...
		onpicked : function(dp) {
			...
			$('#<portlet:namespace />choose_year').val(showtime);
...
// 获取放大表格视图信息
function <portlet:namespace />zoomax(choose_name,choose_id,choose_ispd,start_date,input_start,input_end,choose_type,decimalsForm,commonColumn,multiplier,thisform){
	<portlet:namespace />getForm(choose_name,choose_id,choose_ispd,start_date,input_end,choose_type,decimalsForm,commonColumn);
	// 为选择日期的输入框填入与概览视图相同的日期
	$('#<portlet:namespace />choose_year').val(input_start);
	...
	<portlet:namespace />dayColumn = '';//特殊列
